 ...
 * Abstract DNS Record.
 */
@ApiModel(description = "Abstract DNS Record", discriminator = "_type")
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "_type", visible = true)
@JsonSubTypes({
    @Type(value = DnsRecord.class, name = "dns-record"),
    @Type(value = CorrelatedDnsRecord.class, name = "correlated-dns-record")
})
...
public abstract class AbstractDnsRecord implements Serializable {
